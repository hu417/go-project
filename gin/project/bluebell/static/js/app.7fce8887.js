(function (t) {
    ...
    o.m = t, o.c = n, o.d = function (t, s, e) {
        o.o(t, s) || Object.defineProperty(t, s, {
            enumerable: !0,
            get: e
        })
    }, o.r = function (t) {
        ...
        if (o.r(e), Object.defineProperty(e, "default", {
            ...
            for (var n in t) o.d(e, n, function (s) {
                return t[s]
            }.bind(null, n));
        return e
    }, o.n = function (t) {
    ...
    "56d7": function (t, s, e) {
        ...
        var n = e("2b0e"),
            ...
            o = function () {
                ...
                return e("header", {
                    ...
                    staticClass: "user"
                }, [t._v(t._s(t.currUsername))]), e("div", {
            ...
            l = r,
            u = (e("aee9"), e("2877")),
            m = Object(u["a"])(l, o, c, !1, null, "75d7d08c", null),
            p = m.exports,
            d = {
                components: {
                    HeadBar: p
            ...
            v = d,
            f = (e("7c55"), Object(u["a"])(v, a, i, !1, null, null, null)),
            g = f.exports,
            h = e("8c4f"),
            C = function () {
                var t = this,
            ...
            _ = [function () {
                ...
                return e("div", {
                    ...
                    staticClass: "communities"
                }, [e("h2", {
                    staticClass: "r-c-title"
                }, [t._v("今日火热频道排行榜")]), e("ul", {
                    staticClass: "r-c-content"
                }, [e("li", {
                    ...
                    staticClass: "r-trending"
                }, [e("h2", {
                    staticClass: "r-t-title"
                }, [t._v("持续热门频道")]), e("ul", {
                    staticClass: "rank"
                }, [e("li", {
                    staticClass: "r-t-cell"
                }, [e("div", {
                    staticClass: "r-t-cell-info"
                }, [e("div", {
                    staticClass: "avatar"
                }), e("div", {
                    staticClass: "info"
            ...
            w = b,
            y = (e("97e5"), Object(u["a"])(w, C, _, !1, null, "2baf73fc", null)),
            x = y.exports,
            $ = function () {
                var t = this,
                    s = t.$createElement,
                ...
                return e("div", {
                    ...
                    staticClass: "con-title"
                }, [t._v(t._s(t.post.title))]), e("div", {
                    staticClass: "con-info"
                }, [t._v(t._s(t.post.content))]), t._m(1)])])]), e("div", {
                    staticClass: "right"
                }, [e("div", {
                ...
                }, [t._v("b/" + t._s(t.post.community_name))])]), e("p", {
                    staticClass: "t-desc"
                }, [t._v("树洞 树洞 无限树洞的树洞")]), t._m(2), e("div", {
                    staticClass: "date"
                }, [t._v("Created Apr 10, 2008")]), e("button", {
            ...
            k = L,
            P = (e("f6e4"), Object(u["a"])(k, $, O, !1, null, "4466eba1", null)),
            S = P.exports,
            j = function () {
                var t = this,
                    s = t.$createElement,
            ...
            N = [function () {
                ...
                }, [t._v("1.网络不是法外之地")]), e("li", {
                    staticClass: "p-r-item"
                }, [t._v("2.网络不是法外之地")]), e("li", {
                    staticClass: "p-r-item"
                }, [t._v("3.网络不是法外之地")])])])])
            }],
            R = {
                ...
                methods: {
                    submit: function () {
                        ...
                        this.$axios({
                            ...
                            console.log(s.data), 1e3 == s.code ? t.$router.push({
                                path: t.redirect || "/"
                            }) : console.log(s.msg)
                        })).catch((function (t) {
                            console.log(t)
            ...
            E = R,
            I = (e("0797"), Object(u["a"])(E, j, N, !1, null, "6236a644", null)),
            J = I.exports,
            U = function () {
                var t = this,
                    s = t.$createElement,
                ...
                methods: {
                    submit: function () {
                        ...
                        this.$axios({
                            ...
                            console.log(s.data), 1e3 == s.code ? (localStorage.setItem("loginResult", JSON.stringify(s.data)), t.$store.commit("login", s.data), t.$router.push({
                                path: t.redirect || "/"
                            })) : console.log(s.msg)
                        })).catch((function (t) {
                            console.log(t)
            ...
            B = M,
            D = (e("a87d"), Object(u["a"])(B, U, H, !1, null, "5d78ac92", null)),
            A = D.exports,
            T = function () {
                var t = this,
                    s = t.$createElement,
                ...
                methods: {
                    submit: function () {
                        ...
                        this.$axios({
                            ...
                            console.log(s.data), 1e3 == s.code ? (console.log("signup success"), t.$router.push({
                                name: "Login"
                            })) : console.log(s.msg)
                        })).catch((function (t) {
                            console.log(t)
            ...
            F = z,
            G = (e("71df"), Object(u["a"])(F, T, q, !1, null, "326a7a12", null)),
            K = G.exports,
        ...
        n["a"].prototype.$axios = nt, n["a"].config.productionTip = !1, X.beforeEach((function (t, s, e) {
            console.log(t), console.log(s), t.meta.requireAuth ? localStorage.getItem("loginResult") || "/login" === t.path ? e() : e({
                path: "/login"
            }) : e(), "/login" == t.fullPath && (localStorage.getItem("loginResult") ? e({
                path: s.fullPath
            }) : e())
        })), new n["a"]({
            router: X,
...
//# sourceMappingURL=app.7fce8887.js.map